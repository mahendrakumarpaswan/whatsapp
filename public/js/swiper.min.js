                        ...
                        if ((i.isScrolling && this.emit("touchMoveOpposite", l), void 0 === i.startMoving && ((a.currentX === a.startX && a.currentY === a.startY) || (i.startMoving = !0)), i.isScrolling)) i.isTouched = !1;
                            ...
                            if (
                                ...
                                f > 0 && i.currentTranslate > this.minTranslate()
                                    ? ((v = !1), s.resistance && (i.currentTranslate = this.minTranslate() - 1 + Math.pow(-this.minTranslate() + i.startTranslate + f, g)))
                                    : f < 0 && i.currentTranslate < this.maxTranslate() && ((v = !1), s.resistance && (i.currentTranslate = this.maxTranslate() + 1 - Math.pow(this.maxTranslate() - i.startTranslate - f, g))),
            ...
            update: {
                ...
                updateSlides: function () {
                    ...
                    if (void 0 !== s) {
                        ...
                        if (
                            (0 === p.length && (p = [0]),
                            0 !== t.spaceBetween && (this.isHorizontal() ? (a ? d.filter(f).css({ marginLeft: y + "px" }) : d.filter(f).css({ marginRight: y + "px" })) : d.filter(f).css({ marginBottom: y + "px" })),
            ...
            handle: function (e) {
                ...
                if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || (i.activeElement && i.activeElement.nodeName && ("input" === i.activeElement.nodeName.toLowerCase() || "textarea" === i.activeElement.nodeName.toLowerCase())))) {
                    ...
                    this.isHorizontal()
                        ...
                        : ((d || h || c || f) && (a.preventDefault ? a.preventDefault() : (a.returnValue = !1)), (h || f) && this.slideNext(), (d || c) && this.slidePrev()),
